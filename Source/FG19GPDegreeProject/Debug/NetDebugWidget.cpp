...
void UNetDebugWidget::UpdateNetworkSimulationSettings(const FBlueprintNetworkSimulationSettings& InPackets)
{
	if (UWorld* World = GetWorld())
	{
		if (World->GetNetDriver() != nullptr)
		{
			...
			FBlueprintNetworkSimulationSettingsText SimulationSettingsText;
...
void UNetDebugWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
